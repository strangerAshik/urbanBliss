...
<html lang="en">
	<head>
		...
		<link href="{{ asset('admin/plugins/fancybox/jquery.fancybox.css')}}" rel="stylesheet">
		<link href="{{ asset('admin/plugins/fullcalendar/fullcalendar.css')}}" rel="stylesheet">
		<link href="{{ asset('admin/plugins/xcharts/xcharts.min.css')}}" rel="stylesheet">
	...
	<div class="row">
		<div id="sidebar-left" class="col-xs-2 col-sm-2">
			<ul class="nav main-menu">
				<li>
					<a href="admin/ajax/dashboard.html" class="active ajax-link">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						<li><a class="ajax-link" href="ajax/test.php">test</a></li>
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						<li><a href="{{url('admin/ajax/page_login.html')}}">Login</a></li>
						...
						<li><a class="ajax-link" href="{{url('admin/ajax/page_404.html')}}">Error 404</a></li>
		...
		<div id="content" class="col-xs-12 col-sm-10">
			<div class="preloader">
				{!!Html::image('admin/img/devoops_getdata.gif','preloader',['class'=>'devoops-getdata'])!!}
...
<script src="{{ asset('admin/plugins/jquery/jquery-2.1.0.min.js')}}"></script>
<script src="{{ asset('admin/plugins/jquery-ui/jquery-ui.min.js')}}"></script>
<!-- Include all compiled plugins (below), or include individual files as needed -->
<script src="{{ asset('admin/plugins/bootstrap/bootstrap.min.js')}}"></script>
<script src="{{ asset('admin/plugins/justified-gallery/jquery.justifiedgallery.min.js')}}"></script>
...
<script src="{{ asset('admin/js/devoops.js')}}"></script>
</body>
</html>
